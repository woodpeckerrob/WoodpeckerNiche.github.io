...
det_covs_matrix <- det_covs %>%
  pivot_wider(names_from = visit, values_from = c(wind, sky, observer,time_since_sunrise)) %>%
  arrange(point_id)
...
det_formula <- ~ wind + sky + observer #+ time_since_dawn  # this made some species get way overestimated
