...
# Step 1: Bin the height_ratNULL# Step 1: Bin the height_ratio values
hyper_df2 <- hyper_df %>%
  mutate(
...
#make hawking one thing
hyper_data$air <- hyper_data$air.air.dead_tree+hyper_data$air.air.live_tree
hyper_data$air.air.dead_tree <- NULL
hyper_data$air.air.live_tree <- NULL
